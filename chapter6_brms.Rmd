...
In reality, since we do not know the actual proability distribution.  This approach gives us a way to know, between 2 distributions, which is closer to the target than the other.  This is simply measured by using the aerage log probability of the distribution under question. 
